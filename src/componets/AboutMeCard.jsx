...
import profileImg1 from "../assets/Images/me (1).jpg";
import profileImg2 from "../assets/Images/me (2).jpg";
...
export default function AboutMeCard(props) {
  return (
    <div className="flex md:flex-col flex-col gap-y-7 justify-center items-center w-auto my-10 mx-auto text-center">
      {props.fromRef !== "home" ? (
        <div className="group md:w-[220px] w-[180px] aspect-square rounded-full overflow-hidden border-2 border-[#9676ce]/40 shadow-xl transition-transform duration-300 hover:scale-105 relative">
          <img src={profileImg1} alt="Sudarshan Kakde" className="w-full h-full object-cover transition-opacity duration-500 group-hover:opacity-0" />
          <img src={profileImg2} alt="Sudarshan Kakde" className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        </div>
      ) : (
        <div className="md:self-center flex flex-row w-full md:justify-center items-center gap-6 justify-center">
          <div className="group md:w-[220px] w-[180px] aspect-square rounded-full overflow-hidden border-2 border-[#9676ce]/40 shadow-xl transition-transform duration-300 hover:scale-105 relative cursor-pointer ">
            <img src={profileImg1} alt="Sudarshan Kakde" className="w-full h-full object-cover transition-opacity duration-500 group-hover:opacity-0" />
            <img src={profileImg2} alt="Sudarshan Kakde" className="absolute inset-0 w-full h-full object-cover opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          </div>

          <div className="md:hidden flex flex-col gap-3 justify-center">
            ...
            <Link to="https://github.com/sudarshankakde" target="_blank" rel="noopener noreferrer">
              <svg width="24" height="24" viewBox="0 0 20 20" version="1.1">
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                  <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" fill="#dadada">
            ...
            <Link to="https://linkedin.com/in/sudarshan-kakde-510b15194" target="_blank" rel="noopener noreferrer">
              <svg fill="#dadada" version="1.1" id="Capa_1" width="24" height="24" viewBox="0 0 552.77 552.77">
                <g>
                  <g>
